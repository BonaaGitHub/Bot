...
exports.owner = (botname) =>{
	return` 🙅‍♀️ Command khusus owner deck ${botname}`
	}
exports.admin = (groupName) =>{
	return`🙅‍♀️ Command khusus admin deck ${groupName}`
	}
exports.adminB = () =>{
	return`⚠️ Bot bukan admin grup deck`
	}
exports.err = () =>{
	return`⚠️ Fitur ini sedang eror deck !`
	}
exports.group = () =>{
	return`🙅‍♀️ Command khusus di dalam group deck`
	}
...
│VERSI : 6.66
│FITUR : 300
│CREATOR : Bona Yg Tamvan
│MODEL SCRIPT : BETA
│SUBSCRIBE CHANNEL zBlaze Deck
│https://bit.ly/ytzblaze
╰───────────────┈ ⳹
